 ...
 *
 * Copyright (C) 2011 Valentin Jacquemin.
 *    - Check elements presence during a defined maximum number of times but not basing on the readyness of the DOM (on AJAX call).
 */
...
(function($) {
    ...
    $.elementReady.max_checks = 200; // maximum times of checking the presence of the element (i.e. ~5secs)
